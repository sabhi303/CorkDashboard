...
const GEODEMOS_COLORWAY_CATEGORICAL = [
  "#7fc97f",
  "#beaed4",
  "#fdc086",
  "#ffff99",
...
const GEODEMOS_COLORWAY_CBSAFE = [
  "#d73027",
  "#f46d43",
  "#fdae61",
  "#fee090",
...
export async function mainGeoDemos(groupDescriptions) {
  try {
    ...
    const ATTRIBUTION =
      '© <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>, © <a href="https://carto.com/">CartoDB </a> contributors';
    ...
    d3.select("#query-dropdown__content")
      .selectAll("button")
      .on("click", function () {
        ...
        if (layerNo !== "all") {
          document.getElementById(
            "current-group"
          ).innerHTML = `<p>Group ${buttonData}</p>`;
          // updateGroupTxt(gn)
...
// main() // this needs to be called from the pug then should be sorted
...
function onEachFeature(feature, layer) {
  ...
  const popTextContent =
    "<p><b>Group " +
    feature.properties.cork_clusters_Clusters +
    "</b></p>" +
    "<p><b>" +
    feature.properties.EDNAME +
    "</b></p>" +
    "<p><b>" +
    feature.properties.COUNTYNAME +
    "</b></p>" +
    "<p><b>SA " +
    feature.properties.SMALL_AREA +
    "</b></p>";
...
if (typeof window !== "undefined") {
  window.mainGeoDemos = mainGeoDemos;
}
